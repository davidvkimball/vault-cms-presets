...
var FileNameHistorySettingTab = class extends import_obsidian2.PluginSettingTab {
  ...
  display() {
    ...
    generalGroup.addSetting((setting) => {
      setting.setName("History property name").setDesc("The frontmatter list property to store file name history.").addText(
    ...
    generalGroup.addSetting((setting) => {
      setting.setName("Auto-create properties").setDesc("Automatically create the configured property if missing.").addToggle(
